...
</style> @endpush @section('breadcrumb') @parent <li class="active">Sales Transactions</li>
@endsection
...
<div class="row"> <div class="col-lg-12"> <div class="box">
    ...
    <form class="form-produk">
        ...
        <span class="input-group-btn">
            <button onclick="tampilProduk()" class="btn btn-success btn-flat" type="button"><i class="fa
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-8">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button onclick="tampilMember()" class="btn btn-success btn-flat" type="button"><i
...
<div class="box-footer">
    <button type="submit" class="btn btn-success btn-sm btn-flat pull-right btn-simpan"><i class="fa fa-floppy-o"></i>
...
render: function (data) {
    ...
    function loadForm(diskon = 0, diterima = 0) {
        ...
        $.get(`{{ url('/transaksi/loadform') }}/${diskon}/${$('.total').text()}/${diterima}`)
            .done(response => {
                $('#totalrp').val('₱ ' + response.totalrp.replace(/\./g, ','));
                $('#bayarrp').val('₱ ' + response.bayarrp.replace(/\./g, ','));
                $('#bayar').val(response.bayar);
                $('.tampil-bayar').text('Pay: ₱ ' + response.bayarrp.replace(/\./g, ','));
                $('.tampil-terbilang').text(response.terbilang);

                $('#kembali').val('₱' + response.kembalirp.replace(/\./g, ','));
                if ($('#diterima').val() != 0) {
                    $('.tampil-bayar').text('Return: ₱ ' + response.kembalirp.replace(/\./g, ','));
